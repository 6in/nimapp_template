var
  packageName, version, author, description, license, srcdir, binDir, backend: string
  skipDirs, skipFiles, skipExt, installDirs, installFiles, installExt, bin, requiresData,foreignDeps : seq[string]
